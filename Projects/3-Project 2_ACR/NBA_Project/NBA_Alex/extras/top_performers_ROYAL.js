d3.csv('blk_data.csv', function(data) {
  console.log(data)
...
d3.csv('fg_data.csv', function(data) {
  console.log(data)
...
d3.csv('ast_data.csv', function(data) {
  console.log(data)
...
d3.csv('stl_data.csv', function(data) {
  console.log(data)
...
d3.csv('fnt_data.csv', function(data) {
  console.log(data)
