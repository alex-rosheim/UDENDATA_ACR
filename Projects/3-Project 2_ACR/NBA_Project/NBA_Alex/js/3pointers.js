...
function renderTable(date) {
    ...
    d3.csv("/NBA_Alex/Resources/nba_players.csv", function (error, nbaData) {
        ...
        var yLinearScale = d3.scaleLinear()
            .domain([0, d3.max(nbaData, d => d.FG3M)])
            .range([chartHeight, 0]);
        ...
        teamGroup
            ...
            .attr("y", d => yLinearScale(d.FG3M) + 3)
            .attr("font-family", "sans-serif")
            .attr("font-size", "8px")
            .attr("fill", "black")
            .attr('text-anchor', 'middle')
        ...
        var toolTip = d3.tip()
            ...
            .offset([80, -60])
            .html(function (d) {
                return (`3 POINTERS MADE: ${d.FG3M}<br> ${d.MATCHUP}<br>${d.PLAYER_NAME}<br>${date}`);
            });
